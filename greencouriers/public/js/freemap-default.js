...
function createEmbeddedMap(el,navigable) {
    ...
    safeArgs.zoom = 9; //params.zoom ? parseInt(params.zoom) : DEFAULT_ZOOM_LEVEL;
    ...
    embeddedMap = new OpenLayers.Map.FreeMapIL(el,{navigable:navigable,projection: new OpenLayers.Projection("EPSG:900913"),displayProjection: new OpenLayers.Projection("EPSG:4326"),units: "m",numZoomLevels: 18,maxResolution: 156543.0339,maxExtent: new OpenLayers.Bounds(-20037508, -20037508,20037508, 20037508.34)
						  });
    if (navigable) {
